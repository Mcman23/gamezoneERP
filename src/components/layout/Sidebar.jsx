...
import { Monitor, Gamepad2, Coffee, BarChart3, Settings, LogOut, ChevronLeft, ChevronRight, LayoutDashboard, Warehouse, ShieldAlert, Receipt, DollarSign } from 'lucide-react';
  ...
  return (
    <aside className={cn(
      ...
      <div className="flex items-center gap-3 p-4 border-b border-border h-16">
        ...
        {!collapsed && <span className="text-lg font-bold text-foreground tracking-tight truncate">GameZone</span>}
      </div>
