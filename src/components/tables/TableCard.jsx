        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-muted-foreground">({table.code}) {table.zone === 'cabinet' ? 'Kabinet' : 'Zal'} • {catLabels[table.category]}</p>
            </div>
          </div>
          <Badge variant={statusConfig[table.status]?.variant || 'secondary'} className="text-[10px]">
